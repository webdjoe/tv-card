...
Another possibility for TV integration does not use `media_player.play_media` is to use `input_text.command` entity instead -except Roku, which uses card internal predefined hass service `remote.send_command`.
